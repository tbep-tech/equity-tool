...
# buffer map
buffer_under_map <- mapview::mapview(buffer_under, col.regions = "#F2AD00", layer.name = "1 mile buffer", alpha.regions = 0.5) + mapview::mapview(tb_equity, col.regions = "#00806E", layer.name = "Underserved Communities", alpha.regions = 0.5)

# flowlines map
flowlines_map <- mapview::mapview(tb_flowlines_simp, color = "#004F7E", layer.name = "Flowlines", label = "GNIS_NAME") + mapview::mapview(tb_equity, col.regions = "#00806E", layer.name = "Underserved Communities", alpha.regions = 0.5)
