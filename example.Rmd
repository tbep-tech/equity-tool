...
mapview(tb_equity, col.regions = "black", layer.name = "Underserved Communities") + mapview(tb_flowlines, col.regions = "blue", layer.name = "Flowlines") + mapview(under_buffer, col.regions = "red", layer.name = "1 mile buffer")
```
